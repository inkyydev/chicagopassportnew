...
import BtnAll from "../../components/common/BtnAll";
      ...
      >
        ...
        <div className="col-span-12 md:col-span-7">
          <div className="pl-[25px] max-[1024px]:pl-[10px] max-[767px]:pl-0">
            <h2
              className={` mb-[22px]  max-[767px]:mb-[15px] text-${textColor}`}
            ...
            {paragraphs?.map((p, i) => (
              <p
                key={i}
                className={`max-w-[550px] mb-[16px] text-${textColor}`}
              >
                {p}
              </p>
            ))}
            ...
            {list && (
              <ul
                className={` pl-[27px] max-w-[534px] my-[20px] max-[767px]:text-[14px] max-[767px]:my-[10px] max-[767px]:mb-[18px] text-${textColor} list-disc`}
              >
                {list.map((item, i) => (
            ...
            {final && (
              <p className={`max-w-[550px] mb-[16px] text-${textColor}`}>
                {final}
              </p>
            )}
