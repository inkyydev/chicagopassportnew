...
import BtnHashLink from "../common/BtnHashLink";
  ...
  const features = [
    {
      ...
      title: "Expertise",
      description:
        "Our team of passport and travel experts is highly experienced in navigating the complex world of travel documentation. We handle every requirement with accuracy and care, so you can focus on your journey with peace of mind.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "We understand that travel plans can be time-sensitive. Our streamlined process ensures that your passport or visa is processed quickly, without unnecessary delays.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Your personal information and documents are handled with the utmost confidentiality and protected using secure submission channels.",
    },
  ];
  return (
    <section
      ...
      <div className="container">
        <div className="grid gap-[20px] grid-cols-1 md:grid-cols-2">
          <div className="mb-[20px] md:mb-0">
            ...
            <p className="max-w-[461px] my-[17px]">
            ...
            <BtnHashLink text="Get Started Today" path="/#hero_section" />
          </div>
          ...
          <div>
            {features.map((item, index) => (
              <div
                ...
                className={`cursor-pointer mb-[15px] transition-all duration-200 p-[30px] rounded-[25px] max-sm:p-[20px] max-sm:rounded-[20px] ${
                  activeIndex === index ? "bg-[#122241]" : "bg-[#f8f9fd]"
                } `}
              >
                <div className="flex items-center">
                  <div
                    className={`flex justify-center items-center transition-all duration-200 w-[62px] h-[62px] max-w-[62px] flex-none rounded-[15px] ${
                      activeIndex === index ? "bg-white/10" : "bg-[#fdfdfe]"
                    } `}
                  >
                    <div
                      className={
                ...
                <div
                  className={`transition-all duration-[800ms] overflow-hidden max-h-0 pl-[94px] max-md:pl-0 ${
                    activeIndex === index ? "max-h-[1000px]" : ""
                  }`}
                >
                  <p
                    className={`m-0 transition-all duration-200 max-md:mt-[15px] ${
                      activeIndex === index ? "text-white" : ""
                    } `}
                  >
                    {item.description}
